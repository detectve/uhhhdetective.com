    ...
    >
      <div class="px-6 py-4 inset-x-0 top-0">
        ...
        <p class="text-white">
          ...
          time, delays and cancellations for a station of their choice, using
          the Realtime Trains API.
        </p>
        <br />
        <h2 class="text-white text-xl font-semibold">
